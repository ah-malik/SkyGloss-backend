...
/**
 * Build immutable FX fields at order creation.
 * `exchangeRateAtOrderTime` and `baseCurrencyAmount` must never be changed
 * after the order is placed (except for one-time repair of corrupt legacy rows).
 */
