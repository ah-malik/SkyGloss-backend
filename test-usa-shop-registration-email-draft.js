/**
 * DRAFT USA Shop Registration Email â€“ visual test only.
...
<head>
  ...
  <title>Welcome to SkyGloss â€“ USA Shop Registration</title>
  <!--[if mso]>
  <style type="text/css">
        ...
        <table role="presentation" width="${WIDTH}" cellpadding="0" cellspacing="0" border="0" style="width:${WIDTH}px; max-width:${WIDTH}px;">
          <tbody><tr>
            <td style="padding:16px 8px; font-family: Arial, Helvetica, sans-serif; font-size:11px; color:#888888; text-align:center;">
              DRAFT TEMPLATE â€“ for testing only. Not the live USA shop registration email.
            </td>
          </tr>
        </tbody></table>
...
async function sendDraftUsaShopRegistrationEmail() {
  // Same as welcome draft â€“ certified mailbox. Draft only â€“ not wired to mail.service.ts.
  ...
  const mailOptions = {
    ...
    to: 'it@skygloss.com',
    subject: `[DRAFT TEST] USA Shop Registration Welcome â€“ ${stamp}`,
    html,
  };
